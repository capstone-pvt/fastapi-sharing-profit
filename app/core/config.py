...
class Settings:
    ...
    model_root = _resolve_path("MODEL_ROOT", "models")
    classifier_model_path = _resolve_path("CLASSIFIER_MODEL_PATH", "models/classifier/best.pt")
    weight_model_path = _resolve_path("WEIGHT_MODEL_PATH", "models/weight/weight_model.joblib")
    price_model_path = _resolve_path("PRICE_MODEL_PATH", "models/price/price_model.joblib")
    detector_model_path = _resolve_path("DETECTOR_MODEL_PATH", "models/detector/best.pt")
